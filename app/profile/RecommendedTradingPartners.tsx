...
const partners = [
  ...
  },
  {
    category: "RECOMMENDED PROP FIRM",
    name: "The 5%ers",
    bestFor: "Long-term traders focused on consistency and controlled risk.",
    why: [
      "High Stakes evaluation has no time limit",
      "MT5 Hedge support on High Stakes",
      "Overnight and weekend holding is permitted on the program",
      "Funded payouts are available every 14 days on eligible programs",
    ],
    offer: "Review the current program rules before purchasing an evaluation.",
    href: "https://the5ers.com/high-stakes/",
