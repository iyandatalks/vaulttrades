...
export default function AutomatedTraderPage(){
  ...
  return <main className="shell" style={{maxWidth:1180,margin:"0 auto",padding:"34px 20px 48px"}}>
    <section className="card" style={{textAlign:"center",padding:"44px 28px"}}>
      ...
      <h1 className="title" style={{fontSize:40,lineHeight:1.1,margin:"14px auto 12px"}}>VaultTrades Copy Trading</h1>
      <p className="muted" style={{maxWidth:720,margin:"0 auto",lineHeight:1.7}}>When the VaultTrades service generates a trade, your connected MT5 copy-trading account can mirror the trade automatically. Your account remains yours and execution is subject to your broker's conditions.</p>
    ...
    <section style={{marginTop:24}}>
      <div className="vt-connection">
        {[
          ...
          ["02","MT5 ACCOUNT","Connect the account you want to use for copy trading."],
          ["03","AUTOMATION","VaultTrades manages the connection and trade handoff."],
          ["04","COPY TRADING","Qualifying VaultTrades trades are sent to your connected account."],
    ...
    <section className="card" style={{marginTop:24,textAlign:"center",padding:"30px 26px"}}>
      <div className="section-label">MT5 COPY-TRADING ACCOUNT</div>
      <h2 className="title" style={{fontSize:27,margin:"8px auto"}}>Connect your MetaTrader 5 account</h2>
      <p className="muted" style={{maxWidth:700,margin:"0 auto",lineHeight:1.7}}>This is the MT5 account that will receive the VaultTrades copy trades. Your MT5 password is used only for the connection process and is not stored by VaultTrades.</p>
    ...
    <section style={{marginTop:22,padding:"18px 12px 28px",textAlign:"center",color:"#8992a7",fontSize:12,lineHeight:1.7}}>Trading involves risk. Copy trading and automated execution do not guarantee profits. Your broker may reject, delay or modify execution.</section>
  </main>;
}
