...
type ScannerConfig = { enabled:boolean; observe_mode:boolean; forex_enabled:boolean; crypto_enabled:boolean; enabled_strategies:string[]; timezone:string; };
...
export default function SignalsPage(){
  ...
  return <main className="shell">
    ...
    {config&&<section className="card" style={{marginTop:16}}>
      ...
      <div style={{display:"flex",justifyContent:"space-between",gap:12,flexWrap:"wrap",marginTop:14}}><span className="muted" style={{fontSize:11}}>Strategy: Vault Auto Fib Retrace + TP Ladder · Timezone: {config.timezone}</span>{configSaved&&<span style={{fontSize:11,fontWeight:800}}>Saved</span>}{savingConfig&&<span className="muted" style={{fontSize:11}}>Saving…</span>}</div>
